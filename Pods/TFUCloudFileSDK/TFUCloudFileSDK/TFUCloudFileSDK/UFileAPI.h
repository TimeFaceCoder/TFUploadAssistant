 ...
 */
- (void) putFile:(NSString* _Nonnull)key
 ...
 * @param failure 失败回调，回调函数的参数里面包含kUFileRespXSession
 */
- (void) uploadHit:(NSString* _Nonnull)key
     authorization:(NSString* _Nonnull)authorization
 ...
 * @param failure 失败回调，回调函数的参数里面包含kUFileRespXSession
 */
- (void) getFile:(NSString* _Nonnull)key
   authorization:(NSString* _Nonnull)authorization
          option:(NSDictionary* _Nullable)option
 ...
 * @param failure 失败回调，回调函数的参数里面包含kUFileRespXSession
 */
- (void) headFile:(NSString* _Nonnull)key
    authorization:(NSString* _Nonnull)authorization
          success:(UFileUploadDoneCallback _Nonnull)success
          failure:(UFileOpFailCallback _Nonnull)failure;
 ...
 * @param failure 失败回调，回调函数的参数里面包含kUFileRespXSession
 */
- (void) deleteFile:(NSString* _Nonnull)key
      authorization:(NSString* _Nonnull)authorization
            success:(UFileUploadDoneCallback _Nonnull)success
            failure:(UFileOpFailCallback _Nonnull)failure;
...
/**
 * 设置分片上传的重传策略
 * @param retryTimeLimit 重试的最大次数
 * @param retryInterval  重试的时间间隔(ms)
 */
 ...
 * @param failure 失败回调
 */
- (void) multipartUploadStart:(NSString* _Nonnull)key
                authorization:(NSString* _Nonnull)authorization
 ...
 * @param failure 失败回调
 */
- (void) multipartUploadPart:(NSString* _Nonnull)key
 ...
 * @param failure 失败回调
 */
- (void) multipartUploadAbort:(NSString* _Nonnull)key
                     uploadId:(NSString* _Nonnull)uploadId
               authorization:(NSString* _Nonnull)authorization
                      success:(UFileUploadDoneCallback _Nonnull)success
                      failure:(UFileOpFailCallback _Nonnull)failure;
